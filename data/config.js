 ...
 */
const UI_PALETTES = [
  { id:'lavande', label:'Lavande', bg:'#ddd6e8', lilac:'#b090d0', mint:'#80d0a8', pink:'#e8a0bf', text:'#38304a', text2:'#887ea0', card:'rgba(255,255,255,.88)', border:'#ccc4d8' },
  ...
  { id:'nuit',    label:'Nuit',    bg:'#2a2438', lilac:'#9070c0', mint:'#50c890', pink:'#c07090', { id:'nuit', label:'Nuit', bg:'#2a2438', lilac:'#9070c0', mint:'#50c890', pink:'#c07090', text:'#f4f0ff', text2:'#a090c0', card:'rgba(45,38,60,.95)', border:'#4a4060' },, card:'rgba(45,38,60,.95)',    border:'#4a4060' },
